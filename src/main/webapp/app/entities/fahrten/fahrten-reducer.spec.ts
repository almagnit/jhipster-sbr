...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fahrten.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAHRTEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAHRTEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAHRTEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAHRTEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAHRTEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAHRTEN actions', async () => {
      const expectedActions = [
        {
