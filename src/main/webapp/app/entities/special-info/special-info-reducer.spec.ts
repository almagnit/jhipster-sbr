...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPECIALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALINFO actions', async () => {
      const expectedActions = [
        {
