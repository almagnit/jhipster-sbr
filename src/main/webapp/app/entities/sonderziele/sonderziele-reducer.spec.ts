...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SONDERZIELE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SONDERZIELE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SONDERZIELE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SONDERZIELE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SONDERZIELE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SONDERZIELE actions', async () => {
      const expectedActions = [
        {
