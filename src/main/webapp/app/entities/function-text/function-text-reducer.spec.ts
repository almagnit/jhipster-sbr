...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIONTEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNCTIONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNCTIONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNCTIONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNCTIONTEXT actions', async () => {
      const expectedActions = [
        {
