...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_VTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VTS actions', async () => {
      const expectedActions = [
        {
