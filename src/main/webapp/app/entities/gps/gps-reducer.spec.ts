...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gps.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GPS actions', async () => {
      const expectedActions = [
        {
