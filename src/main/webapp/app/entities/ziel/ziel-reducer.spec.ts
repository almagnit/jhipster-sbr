...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ziel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZIEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ZIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ZIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ZIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ZIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ZIEL actions', async () => {
      const expectedActions = [
        {
