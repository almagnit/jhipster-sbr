...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORT actions', async () => {
      const expectedActions = [
        {
