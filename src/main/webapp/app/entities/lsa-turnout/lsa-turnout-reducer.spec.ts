...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LSATURNOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_LSATURNOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LSATURNOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LSATURNOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LSATURNOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LSATURNOUT actions', async () => {
      const expectedActions = [
        {
